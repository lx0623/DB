        ...
        context_t& context )
{
            ...
            context_t& context, bool bDistinct )
    {
        ...
        if( bDistinct )
        {
            ...
            segmented_sort< launch_box_t< arch_52_cta< 256, 3 > > >( pData, tupleNum, groups, groupCount, less_t_null_smaller< type_t >(), context );
...
// no sum for AriesYear
        ...
        switch( aggType )
        {
            case AriesAggFunctionType::COUNT:
            {
                ...
                if( bDistinct )
                {
                    ...
                    //memcpy( pData, data, tupleNum * sizeof( type_t ) );
                    cudaMemcpy( pData, data, tupleNum * sizeof(type_t), cudaMemcpyDefault );
                    segmented_sort< launch_box_t< arch_52_cta< 256, 3 > > >( pData, tupleNum, groups, groupCount, less_t_null_smaller< type_t >(),
                            context );
            ...
            size_t groupCount, context_t& context, bool bDistinct )
    {
        ...
        if( bDistinct )
        {
            ...
            segmented_sort< launch_box_t< arch_52_cta< 128, 5 > > >( pData, tupleNum, groups, groupCount,
            ...
            case AriesAggFunctionType::SUM:
            {
                ...
                if( bDistinct )
                {
                    ...
                    if( !hasNull )
                    {
                        ...
                        not_equal_to_t_CompactDecimal< false, false > func( prec, sca );
                        lbs_segreduce< launch_box_t< arch_52_cta< 256, 3 > > >(
