...
// #define SET_INT_BIT_FLAG( flags, index )                                                                                                             \
//     do                                                                                                                                               \
//     {                                                                                                                                                \
//         atomicOr( (int32_t *) flags + ( index / 32 ), ( 1 << ( 31 - index % 32 ) ) );                                                                \
//     } while ( 0 )

// #define CLEAR_INT_BIT_FLAG( flags, index )                                                                                                           \
//     do                                                                                                                                               \
//     {                                                                                                                                                \
//         atomicAnd( (int32_t *) flags + ( index / 32 ), ~( 1 << ( 31 - index % 32 ) ) );                                                              \
//     } while ( 0 )

// #define GET_INT_BIT_FLAG( flags, index, out )                                                                                                        \
//     do                                                                                                                                               \
//     {                                                                                                                                                \
//         uint32_t target = atomicAnd( (int32_t *) flags + ( index / 32 ), 0xFFFFFFFF );                                                               \
//         out = ( ( uint32_t )( target << ( index % 32 ) ) ) >> 31;                                                                                    \
//     } while ( 0 )
