...
SimplifiedResult ExpressionSimplifier::simplifyCalc(CommonBiaodashi *origin, THD* thd, bool &success)
{
    ...
    {
        aries_acc::Decimal leftValue = 0;
        aries_acc::Decimal rightValue = 0;
        ...
        case 8:
        {
            leftValue = boost::get<bool>(left);
            break;
        }
        case 11:
        {
            leftValue = boost::get<int64_t>(left);
            break;
        }
        }
        ...
        case 8:
        {
            rightValue = boost::get<bool>(right);
            break;
        }
        case 11:
        {
            rightValue = boost::get<int64_t>(right);
            break;
        }
        }
